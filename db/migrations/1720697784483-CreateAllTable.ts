...
// export class CreateAllTable1720697784483 implements MigrationInterface {
//     name = 'CreateAllTable1720697784483'
...
//         await queryRunner.query(`CREATE TABLE \`JewelrySettingVariant\` (\`JewelrySettingVariantID\` int NOT NULL AUTO_INCREMENT, \`SizeID\` int NULL, \`JewelrySettingID\` int NULL, \`MaterialJewelryID\` int NULL, \`Weight\` decimal(10,2) NOT NULL, \`Quantity\` int NOT NULL DEFAULT '0', PRIMARY KEY (\`JewelrySettingVariantID\`)) ENGINE=InnoDB`);
...
//         await queryRunner.query(`CREATE TABLE \`Order\` (\`OrderID\` int NOT NULL AUTO_INCREMENT, \`OrderDate\` datetime NOT NULL, \`CompleteDate\` datetime NOT NULL, \`IsPayed\` tinyint NOT NULL, \`Shippingfee\` decimal(10,2) NULL, \`ReasonReturn\` text NULL, \`Note\` text NULL, \`CustomerID\` int NULL, \`OrderStatus\` varchar(255) NULL, \`IsActive\` tinyint NOT NULL, \`AccountDeliveryID\` int NULL, \`AccountSaleID\` int NULL, \`PaymentID\` varchar(255) NULL, \`Method\` varchar(255) NULL, PRIMARY KEY (\`OrderID\`)) ENGINE=InnoDB`);
//         await queryRunner.query(`CREATE TABLE \`Voucher\` (\`VoucherID\` int NOT NULL AUTO_INCREMENT, \`VoucherCode\` varchar(255) NULL, \`Description\` varchar(255) NULL, \`StartDate\` datetime NOT NULL, \`EndDate\` datetime NOT NULL, \`PercentDiscounts\` decimal(8,2) NOT NULL, \`OrderID\` int NULL, PRIMARY KEY (\`VoucherID\`)) ENGINE=InnoDB`);
