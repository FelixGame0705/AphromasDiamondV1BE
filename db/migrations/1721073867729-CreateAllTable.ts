...
export class CreateAllTable1721073867729 implements MigrationInterface {
    name = 'CreateAllTable1721073867729'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`OrderLine\` (\`OrderLineID\` int NOT NULL AUTO_INCREMENT, \`Quantity\` int NOT NULL DEFAULT '1', \`Price\` int NULL, \`OrderID\` int NULL, \`DiamondID\` int NULL, \`ProductID\` int NULL, \`CustomerID\` int NULL, UNIQUE INDEX \`REL_87d1a0e4fca950091a52e91be4\` (\`DiamondID\`), PRIMARY KEY (\`OrderLineID\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Order\` (\`OrderID\` int NOT NULL AUTO_INCREMENT, \`OrderDate\` datetime NOT NULL, \`CompleteDate\` datetime NOT NULL, \`IsPayed\` tinyint NOT NULL, \`Shippingfee\` decimal(10,2) NULL, \`ReasonReturn\` text NULL, \`Note\` text NULL, \`CustomerID\` int NULL, \`OrderStatus\` varchar(255) NULL, \`IsActive\` tinyint NOT NULL, \`Price\` int NULL, \`AccountDeliveryID\` int NULL, \`AccountSaleID\` int NULL, \`PaymentID\` varchar(255) NULL, \`Method\` varchar(255) NULL, \`VoucherID\` int NULL, PRIMARY KEY (\`OrderID\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`Diamond\` (\`DiamondID\` int NOT NULL AUTO_INCREMENT, \`Name\` varchar(255) NULL, \`Shape\` varchar(255) NULL, \`Cut\` varchar(255) NULL, \`Price\` decimal(10,2) NULL, \`DiscountPrice\` decimal(10,2) NULL, \`Color\` varchar(255) NULL, \`WeightCarat\` decimal(7,3) NULL, \`PercentDepth\` decimal(7,3) NULL, \`LengthOnWidthRatio\` decimal(7,2) NULL, \`Description\` text NULL, \`IsActive\` tinyint NULL, \`Fluorescence\` varchar(255) NULL, \`Clarity\` varchar(255) NULL, \`PercentTable\` decimal(7,2) NULL, \`Polish\` varchar(255) NULL, \`Symmetry\` varchar(255) NULL, \`ChargeRate\` decimal(7,2) NULL, \`UpdateTime\` datetime NOT NULL, \`JewelrySettingVariantID\` int NULL, \`ProductID\` int NULL, \`CollectionID\` int NULL, \`DiscountID\` int NULL, \`Designer\` varchar(255) NULL, \`Cutter\` varchar(255) NULL, \`IndexVariantGroup\` int NULL, \`Quantity\` int NOT NULL DEFAULT '0', PRIMARY KEY (\`DiamondID\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`JewelrySettingVariant\` (\`JewelrySettingVariantID\` int NOT NULL AUTO_INCREMENT, \`SizeID\` int NULL, \`JewelrySettingID\` int NULL, \`MaterialJewelryID\` int NULL, \`Weight\` decimal(10,2) NOT NULL, \`Quantity\` int NOT NULL DEFAULT '0', \`Price\` int NULL, PRIMARY KEY (\`JewelrySettingVariantID\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`Product\` ADD CONSTRAINT \`FK_8ad7c9e325be1665be3c021fdc0\` FOREIGN KEY (\`JewelrySettingVariantID\`) REFERENCES \`JewelrySettingVariant\`(\`JewelrySettingVariantID\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
