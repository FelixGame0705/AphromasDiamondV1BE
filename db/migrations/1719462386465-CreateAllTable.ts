...
export class CreateAllTable1719462386465 implements MigrationInterface {
    name = 'CreateAllTable1719462386465'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`JewelrySettingVariant\` (\`JewelrySettingVariantID\` int NOT NULL AUTO_INCREMENT, \`SizeID\` int NOT NULL, \`JewelrySettingID\` int NOT NULL, \`MaterialJewelryID\` int NOT NULL, PRIMARY KEY (\`JewelrySettingVariantID\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`Product\` (\`ProductID\` int NOT NULL AUTO_INCREMENT, \`JewelrySettingID\` int NULL, \`CustomerID\` int NULL, PRIMARY KEY (\`ProductID\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`Diamond\` (\`DiamondID\` int NOT NULL AUTO_INCREMENT, \`Name\` varchar(255) NULL, \`Shape\` varchar(255) NULL, \`Cut\` varchar(255) NULL, \`Price\` int NULL, \`Color\` varchar(255) NULL, \`WeightCarat\` int NULL, \`PercentDepth\` int NULL, \`LengthOnWidthRatio\` int NULL, \`Description\` text NULL, \`IsActive\` tinyint NULL, \`Fluorescence\` varchar(255) NULL, \`Clarity\` varchar(255) NULL, \`PercentTable\` int NULL, \`Polish\` varchar(255) NULL, \`Symmetry\` varchar(255) NULL, \`ChargeRate\` int NULL, \`UpdateTime\` datetime NOT NULL, \`JewelrySettingID\` int NULL, \`ProductID\` int NULL, PRIMARY KEY (\`DiamondID\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`Product\` ADD CONSTRAINT \`FK_74513ce10452d13ee7de1bb555c\` FOREIGN KEY (\`CustomerID\`) REFERENCES \`Customer\`(\`CustomerID\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`Product\` DROP FOREIGN KEY \`FK_74513ce10452d13ee7de1bb555c\``);
