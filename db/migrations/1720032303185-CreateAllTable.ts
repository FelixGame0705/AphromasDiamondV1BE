...
export class CreateAllTable1720032303185 implements MigrationInterface {
    name = 'CreateAllTable1720032303185'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`UsingImage\` (\`UsingImageID\` int NOT NULL AUTO_INCREMENT, \`ProductID\` int NOT NULL, \`DiamondID\` int NULL, \`JewelrySettingID\` int NULL, \`Name\` varchar(255) NOT NULL, \`url\` varchar(255) NULL, PRIMARY KEY (\`UsingImageID\`)) ENGINE=InnoDB`);
