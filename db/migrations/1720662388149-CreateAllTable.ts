...
export class CreateAllTable1720662388149 implements MigrationInterface {
    name = 'CreateAllTable1720662388149'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`Diamond\` (\`DiamondID\` int NOT NULL AUTO_INCREMENT, \`Name\` varchar(255) NULL, \`Shape\` varchar(255) NULL, \`Cut\` varchar(255) NULL, \`Price\` int NULL, \`Color\` varchar(255) NULL, \`WeightCarat\` int NULL, \`PercentDepth\` int NULL, \`LengthOnWidthRatio\` int NULL, \`Description\` text NULL, \`IsActive\` tinyint NULL, \`Fluorescence\` varchar(255) NULL, \`Clarity\` varchar(255) NULL, \`PercentTable\` int NULL, \`Polish\` varchar(255) NULL, \`Symmetry\` varchar(255) NULL, \`ChargeRate\` int NULL, \`UpdateTime\` datetime NOT NULL, \`JewelrySettingVariantID\` int NULL, \`ProductID\` int NULL, \`CollectionID\` int NULL, \`DiscountID\` int NULL, \`Designer\` varchar(255) NULL, \`Cutter\` varchar(255) NULL, \`IndexVariantGroup\` int NULL, \`Quantity\` int NOT NULL DEFAULT '0', PRIMARY KEY (\`DiamondID\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`Order\` (\`OrderID\` int NOT NULL AUTO_INCREMENT, \`OrderDate\` datetime NOT NULL, \`CompleteDate\` datetime NOT NULL, \`IsPayed\` tinyint NOT NULL, \`Shippingfee\` int NULL, \`ReasonReturn\` text NULL, \`Note\` text NULL, \`CustomerID\` int NULL, \`OrderStatus\` varchar(255) NULL, \`IsActive\` tinyint NOT NULL, \`AccountDeliveryID\` int NULL, \`AccountSaleID\` int NULL, \`PaymentID\` varchar(255) NULL, \`Method\` varchar(255) NULL, PRIMARY KEY (\`OrderID\`)) ENGINE=InnoDB`);
